import {
  ...
  import bilibili from "../../assets/images/team/blg.jpg";
  import Bin from "../../assets/images/member/blg_bin.jpg";
  import Xun from "../../assets/images/member/blg_xun.jpg";
  import Knight from "../../assets/images/member/blg_knight.jpg";
  import ELK from "../../assets/images/member/blg_elk.jpg";
  import ON from "../../assets/images/member/blg_on.jpg";
  import Zeus from "../../assets/images/member/t1_zeus.jpg";
  import Oner from "../../assets/images/member/t1_oner.jpg"
  import Faker from "../../assets/images/member/t1_faker.jpg";
  import Guma from "../../assets/images/member/t1_gumayusi.jpg";
  import Keria from "../../assets/images/member/t1_keria.jpg";
  import champ from "../../assets/images/team/championship.jpg";
      ...
      <div>
          ...
          {BlogData.map((blg, index) => (
            <Col sm="8" lg="8" xl="6" key={index}>
              <Blog
                ...
                color={blg.btnbg}
                onReadMoreClick={scrollToDetails} //將滾動函數傳到blog組件中
                height={blg.height}
              />
            </Col>
          ))}
        ...
        <Row>
          ...
          <Col>
            <CardGroup>
              <Card>
                <CardImg alt="Card image cap" src={bg1} top width="20%" />
                <CardBody>
              ...
              <Card>
                ...
                <CardBody>
                  <CardTitle tag="h5">賽事分析</CardTitle>
                  <CardSubtitle className="mb-2 text-muted" tag="h6">
                    Card subtitle
                  </CardSubtitle>
                  <CardText>
